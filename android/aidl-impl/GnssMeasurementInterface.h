...
public:
    ::ndk::ScopedAStatus setCallback(const std::shared_ptr<IGnssMeasurementCallback>& in_callback,
            bool in_enableFullTracking, bool in_enableCorrVecOutputs) override;
    ::ndk::ScopedAStatus close() override;

private:
    std::shared_ptr<IGnssMeasurementCallback> mGnssMeasurementCb = nullptr;
};
